...
import { 
  ...
  CornerDownRight, Layers, ArrowUpRight, Search, RotateCcw, AlertTriangle, Info, Calendar, User
} from "lucide-react";
                  ...
                  <div className="bg-white rounded-2xl border border-slate-200/60 p-6 space-y-6 shadow-sm">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        placeholder="Detailed industry description in Markdown..." 
                      />
                          ...
                          <div className="lg:col-span-2 space-y-3">
                            ...
                            <div className="flex gap-2">
                              <Button 
                                ...
                                variant="outline" 
                                size="sm" 
                                className="h-7.5 rounded text-[10px] font-bold text-red-650 border-red-100 hover:bg-red-50"
                              >
                                Remove Image
                              </Button>
                              <Button 
