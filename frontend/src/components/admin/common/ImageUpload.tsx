    ...
    <div className={cn("space-y-3", className)}>
      ...
      {hasPreview ? (
        ...
        <div
          ...
          onDrop={handleDrop}
          className={cn(
            "relative flex flex-col items-center justify-center rounded-2xl border-2 border-dashed px-6 py-10 text-center transition-all cursor-pointer outline-none",
            "bg-slate-50/50 border-slate-300/80 hover:border-emerald-300 hover:bg-emerald-50/30",
        ...
        >
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(16,185,129,0.04)_0%,transparent_55%)] pointer-events-none rounded-2xl" />
          ...
          {isUploading ? (
            ...
            <div className="relative z-10 flex flex-col items-center gap-3">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-emerald-600 shadow-[0_4px_20px_rgba(16,185,129,0.08)] border border-emerald-50/50">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="h-9 rounded-xl text-xs font-bold gap-1.5 border-slate-200 bg-white shadow-sm pointer-events-none"
              >
