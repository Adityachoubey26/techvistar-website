          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="bg-red-50/50 border border-red-100/50 rounded-2xl p-5 flex flex-col gap-4 transition-all duration-300 hover:bg-red-50/80">
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm font-bold text-red-800">Operational Obstacles</div>
              </div>
              <div className="space-y-2">
                <p className="text-xs font-semibold text-red-700/90 leading-relaxed mb-2">
              ...
              <div className="mt-auto pt-3 border-t border-red-200/50">
                <span className="text-[10px] font-bold text-red-500 uppercase tracking-widest block">System Impact</span>
                <p className="text-xs font-bold text-red-700 mt-1 leading-relaxed">{solution.challenges.impact}</p>
              </div>
            </div>
            ...
            <div className="bg-emerald-50/50 border border-emerald-100/50 rounded-2xl p-5 flex flex-col gap-4 transition-all duration-300 hover:bg-emerald-50/80">
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm font-bold text-emerald-800">Our Tailored Approach</div>
              </div>
              <div className="space-y-3">
                {solution.ourSolution.capabilities.map((cap, i) => (
                  <div key={i} className="flex gap-2.5 items-center">
                    <div className="h-5 w-5 rounded-full bg-emerald-50 flex items-center justify-center border border-emerald-100 shrink-0">
                      <span className="text-emerald-600 text-[10px] font-bold">{i + 1}</span>
                    </div>
                    <span className="text-xs font-semibold text-emerald-700">{cap}</span>
                  </div>
                ))}
              </div>
            </div>
